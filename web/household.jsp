<%-- 
    Document   : household
    Created on : 27 Nov, 2018, 10:35:43 AM
    Author     : kauls
--%>
    ...
    <body>
	 ...
	 <div class="gallery" id = "gallery">
                    ...
                    <% while(rs.next())
            {
              ...
              %>
                            <div class="column">
                        <button onclick="document.getElementById('id<%=i%>').style.display='block'" id="h<%=i%>"><img src="images/household/h<%=i%>.jpg" alt="satellite" ></button>
