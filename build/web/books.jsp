<%-- 
    Document   : books
    Created on : 22 Nov, 2018, 12:42:03 PM
    Author     : kauls
--%>
    ...
    <body>
        ...
        int i=0;%>
            ...
            <% while(rs.next())
            {
              ...
              %>
              <div class="column">
                        <button onclick="document.getElementById('id<%=i%>').style.display='block'" id="r<%=i%>"><img src="images/books/r<%=i%>.jpg" alt="satellite" ></button>
