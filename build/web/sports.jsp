<%-- 
    Document   : sports
    Created on : 27 Nov, 2018, 10:25:31 AM
    Author     : kauls
--%>
    ...
    <body>
	 ...
	 <div class="gallery" id = "gallery">
                    ...
                    <% while(rs.next())
            {
              ...
              %>
                            <div class="column">
                        <button onclick="document.getElementById('id<%=i%>').style.display='block'" id="t<%=i%>"><img src="images/sports/t<%=i%>.jpg" alt="satellite" ></button>
