<%-- 
    Document   : cars
    Created on : 27 Nov, 2018, 10:39:04 AM
    Author     : kauls
--%>
    ...
    <body>
	 ...
	 <div class="gallery" id = "gallery">
                    ...
                    <% while(rs.next())
            {
              ...
              %>
                            <div class="column">
                        <button onclick="document.getElementById('id<%=i%>').style.display='block'" id="a<%=i%>"><img src="images/cars/a<%=i%>.jpg" alt="satellite" ></button>
